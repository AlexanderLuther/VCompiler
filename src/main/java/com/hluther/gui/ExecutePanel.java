 ...
 * @author helmuth
 */
public class ExecutePanel extends javax.swing.JPanel {

    private VCompilerFrame vCompilerFrame;
        
    public ExecutePanel(VCompilerFrame vCompilerFrame){
    ...
    private void initComponents() {
        ...
        optimizedCodeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/executeOptimizedCode.png"))); // NOI18N
        ...
        assemblerButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/executeAssembler.png"))); // NOI18N
        ...
        codeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/executeCode.png"))); // NOI18N
