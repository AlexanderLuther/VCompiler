...
public class DoWhile implements Instruction{
     ...
     */
    public DoWhile(Operation condition, LinkedList<Instruction> instructions) {
    ...
    public String generateOnlyReadThreeAddressCode(ThreeAddressCodeDriver threeAddressCodeDriver) {
        ...
        //Agregar las instrucciones a ejecutar para que estas se ejecuten por lo menos una vez
    ...
    public Object analyze(SymbolTable symbolTable, AbstractSyntaxTree ast, VCompilerFrame vCompilerFrame) { 
        ...
        //Analizar las instrucciones del Do -While    
